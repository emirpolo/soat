...
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_1, tasa_co: 13.29, tasa_runt: tasaRunt, valor_prima: 326800)
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_2, tasa_co: 15.99, tasa_runt: tasaRunt, valor_prima: 393200)
subtipo = Subtipo.create(subtipo: '1500 a 2500 c.c.', min: 1500, max: 2500  )
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_1, tasa_co: 15.88, tasa_runt: tasaRunt, valor_prima: 390400)
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_2, tasa_co: 18.82, tasa_runt: tasaRunt, valor_prima: 462700)
subtipo = Subtipo.create(subtipo: 'Más de 2500 c.c.', min: 2501, max: 9999  )
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_1, tasa_co: 18.63, tasa_runt: tasaRunt, valor_prima: 458100)
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_2, tasa_co: 21.39, tasa_runt: tasaRunt, valor_prima: 525900)
...
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_2, tasa_co: 14.90, tasa_runt: tasaRunt, valor_prima: 366300)
subtipo = Subtipo.create(subtipo: 'De 5 a 15 ton', min: 5, max: 15)
tiposubtipo = Tiposubtipo.create(tipo: tipo, subtipo: subtipo, edad: edades_2, tasa_co: 21.53, tasa_runt: tasaRunt, valor_prima: 592400)
